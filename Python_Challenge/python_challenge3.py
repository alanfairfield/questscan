...
# Use Regex to look for patterns of three uppercase letters, one lowercase letter, then three uppercase letters

import re

# Define the text that we will be parsing
...
pattern = r'[a-z][A-Z][A-Z][A-Z][a-z][A-Z][A-Z][A-Z][a-z]+' #find all AAAaAAA patterns, '?' denotes... 
